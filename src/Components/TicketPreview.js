  ...
  return (
    <div className={classes.ticketPreview}>
      <Link
        ...
        to={{
          pathname: `/ticket/${props.data.ticket_number}`,
          state: {
            view: props.view,
      ...
      >
        ...
        <div className={classes.ticketPreviewImageContainer}>
          <img
            src={`/img/oh_${props.data.price}_${props.data.ticket_number}.jpg`}
            className={classes.ticketPreviewImage}
            alt={props.data.name.concat(' Scratch Off Ticket Preview')}
          />
        </div>

        <div className={classes.ticketPreviewInfo}>
          <span className={classes.ticketPreviewPrice}>
            ${props.data.price}
          </span>
